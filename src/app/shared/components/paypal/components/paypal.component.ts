...
import {
    ...
    ICreateSubscriptionCallbackData, IInitCallbackData,
...
export class NgxPaypalComponent implements OnChanges, OnDestroy, AfterViewInit {
    ...
    reinitialize(config: IPayPalConfig | undefined): void {
        ...
        if (this.payPalButtonContainerElem &&
            ...
            (this.payPalButtonContainerElem.nativeElement as HTMLElement).contains(this.payPalButtonContainerElem.nativeElement.firstChild as HTMLElement)
            && this.payPalButtonContainerElem.nativeElement.childElementCount == 2) {

            try {
                this.payPalButtonContainerElem.nativeElement.removeChild(this.payPalButtonContainerElem.nativeElement.firstChild as HTMLElement);
            } catch (e) { }
        }
    }
